...
fn canonical_document_links_resolve_inside_the_repository() {
    const CANONICAL_DOCUMENTS: &[&str] = &[
        ...
        "docs/README.md",
        "docs/authority/DECISIONS-TO-LOCK.md",
        "docs/authority/DOCUMENT-INVENTORY.md",
        "docs/authority/MIGRATION-AND-DEPRECATION.md",
        "docs/authority/MVP-SCENARIO.md",
        "docs/authority/AUTHORITATIVE-TESTING-STANDARD-AND-MIGRATION-PLAN.md",
        "docs/active/FOUNDATION-TEST-AND-UX-HARDENING-PLAN.md",
        "docs/active/FOUNDATION-BASIC-COLONY-LOOP-PLAN.md",
        "docs/active/FOUNDATION-UI-IMPROVEMENT-PLAN.md",
        "docs/active/FOUNDATION-FACTORY-EVENT-PIPELINE-PLAN.md",
        "docs/active/FOUNDATION-STABILIZATION-AND-CONSOLE-HARDENING-PLAN.md",
        "testing/FOUNDATION-REQUIREMENT-MAP.md",
        "testing/FOUNDATION-TEST-EVIDENCE.md",
        "testing/VISUAL-ACCEPTANCE-MATRIX.md",
