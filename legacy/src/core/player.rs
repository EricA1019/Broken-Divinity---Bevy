...
impl PlayerBundle {
    pub fn new(x: i32, y: i32) -> Self {
        ...
        Self {
            ...
            viewshed: Viewshed::new(cfg.player.starting_viewshed_range),
            name: EntityName {
                name: "Player".to_string(),
            },
            stats: CombatStats {
                hp: cfg.player.starting_hp,
                hp_max: cfg.player.starting_hp_max,
                speed: cfg.player.starting_speed,
                ar: cfg.player.starting_ar,
                md: cfg.player.starting_md,
                skills,
            },
            budget: ActionBudget::new(cfg.player.starting_speed),
            statuses: StatusEffects::default(),
            inventory: Inventory::default(),
            equipment: Equipment {
                weapon: Some(cfg.player.starting_weapon_id.clone()),
                armor: None,
                accessory: None,
            },
