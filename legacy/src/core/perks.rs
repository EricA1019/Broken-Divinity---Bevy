...
impl PerkId {
    ...
    pub fn lane_label(&self) -> &'static str {
        match self {
            Self::HeavySwing | Self::CleaveStrike | Self::Unstoppable => {
                "Thumos + Melee Training"
            }
            Self::SteadyAim | Self::QuickReload | Self::Deadeye => {
                "Prudence + Ranged Training"
            }
            Self::GhostStep | Self::FalseTrail | Self::AmbushExtraction => {
                "Metis + Quiet Movement"
            }
...
mod tests {
    ...
    fn test_queue_progression_lane_perks_requires_both_thresholds() {
        ...
        insufficient_virtue_progression
            .virtues
            .insert(VirtueId::Thumos, VirtueState { rank: BELOW_REQUIRED_VIRTUE_RANK });
        ...
        insufficient_training_progression
            .virtues
            .insert(VirtueId::Thumos, VirtueState { rank: REQUIRED_VIRTUE_RANK });
    ...
    fn test_queue_progression_lane_perks_for_metis_quiet_movement() {
        ...
        assert_eq!(
            unlocked,
            vec![PerkId::GhostStep, PerkId::FalseTrail, PerkId::AmbushExtraction]
        );
        assert_eq!(
            pending.pending,
            vec![PerkId::GhostStep, PerkId::FalseTrail, PerkId::AmbushExtraction]
    ...
    fn test_fortitude_melee_training_lane_unlocks_all_toughness_perks() {
        ...
        progression
            .virtues
            .insert(VirtueId::Fortitude, VirtueState { rank: FORTITUDE_T3_VIRTUE_RANK });
    ...
    fn test_fortitude_melee_training_lane_tier_gating() {
        ...
        progression_t1
            .virtues
            .insert(VirtueId::Fortitude, VirtueState { rank: FORTITUDE_T1_VIRTUE_RANK });
        ...
        progression_t2
            .virtues
            .insert(VirtueId::Fortitude, VirtueState { rank: FORTITUDE_T2_VIRTUE_RANK });
    ...
    fn test_fortitude_melee_training_lane_requires_both_thresholds() {
        ...
        progression1.virtues.insert(
            VirtueId::Fortitude,
            VirtueState { rank: FORTITUDE_T1_VIRTUE_RANK - 1 },
        );
        ...
        assert!(unlocked1.is_empty(), "Should not unlock with insufficient virtue rank");
        ...
        assert!(unlocked2.is_empty(), "Should not unlock with insufficient melee training");
    }

    #[test]
    fn test_toughness_perk_lane_label_is_fortitude_melee_training() {
        assert_eq!(PerkId::ThickSkin.lane_label(), "Fortitude + Melee Training");
        assert_eq!(PerkId::SecondWind.lane_label(), "Fortitude + Melee Training");
