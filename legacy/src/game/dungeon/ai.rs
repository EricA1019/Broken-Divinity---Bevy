...
use crate::core::stats::{
    CombatStats, EntityName, PlayerProgression, ProficiencyId, VirtueId,
};
            ...
            && has_los((pos.x, pos.y), player_xy, &map)
        {
                    ...
                    .is_some()
            {
                ...
                for perk in queue_progression_lane_perks(
                    ...
                    log.push(
                        format!("New perk available: {} [{}].", perk.name(), perk.lane_label()),
                        LogColor::Status,
                        time.turn,
                    );
                }
...
mod tests {
    ...
    fn test_enemy_ranged_check_breakdown_formats_expected_terms() {
        ...
        let breakdown =
            enemy_ranged_check_breakdown(18, &progression, &PlayerPerks::default(), 11);
    ...
    fn test_enemy_ranged_check_breakdown_uses_progression_when_component_present() {
        ...
        let breakdown =
            enemy_ranged_check_breakdown(17, &progression, &PlayerPerks::default(), 0);
    ...
    fn test_enemy_ai_stops_after_fatal_ranged_hit() {
        ...
        assert!(shot_logs[0].text.contains("[ATK 10000 vs DV 11 = MET 5 + QUI 6]"));
    ...
    fn test_enemy_ai_ranged_logs_progression_defense_breakdown() {
        ...
        assert!(shot_log.text.contains("[ATK 10000 vs DV 11 = MET 5 + QUI 6]"));
    }
    ...
    fn test_enemy_ai_ranged_miss_trains_quiet_movement() {
        ...
        assert_eq!(progression.proficiency_rating(ProficiencyId::QuietMovement), 42);
        assert!(world
            .resource::<GameLog>()
            .entries()
            .iter()
