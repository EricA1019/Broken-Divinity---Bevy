...
| Clean shelter overview | `outpost_clean` | S,C,Y,G,P | `visual_scene_contract::canonical_outpost_scene_matches_all_visual_representations` | Open | Green | Open | Open | n/a | Green | Green | Green | THC-04/05; GDD 6/8 | Green unreviewed: player-presence buffers and C8 PTY overview pass; semantic/style evidence remains open |
...
| Build selection | `build_selection` | S,C,Y,G,T,P | `visual_transition_contract::build_selection_changes_only_authorized_visual_regions`; `bd_tui::lib::tests::build_selection_and_placement_fit_both_supported_profiles` | Open | Green | Open | Open | Open | Green | Green | Green | THC-01/06; GDD 6/8 | Green unreviewed: all six data-driven entries, selected effect, and truthful `1-6` controls pass both buffers and PTY; semantic/style/transition evidence remains open |
...
| Invalid build placement | `build_invalid_egress` | S,C,Y,G,T,P | `bd_tui::lib::tests::invalid_build_preview_explains_egress_rejection`; `phase6_input::invalid_build_confirmation_keeps_preview_active_and_is_atomic` | Green | Green | Open | Open | Green | Green | Green | Green | THC-04/05/06 | Green unreviewed: invalid preview remains visible, correctable, and atomic at both automated and PTY profiles; resolved-style evidence remains open |
...
| Station staffing | `station_staffing` | S,C,Y,G,T,P | `phase6_input::station_staffing_lists_station_assignments_not_gathering_tasks`; staffing render tests | Green | Green | Open | Green | Green | Green | Green | Green | THC-01/03/06 | Green unreviewed: station-only choices, duplicate wrapped processor rows, distinct title/cancel key, and staffed glyph pass; resolved-style snapshots remain open |
...
| Worker blocked | `worker_blocked` | S,C,Y,G,P | `phase6_input::blocked_direct_gatherer_projects_target_and_actionable_reason`; `survivor_work_contract::unreachable_worker_stays_put_and_reports_a_specific_blocked_reason` | Green | Open | Open | Open | n/a | Open | Open | Open | THC-02/03/05; D-22 | Green unreviewed: domain and projection name the target and actionable reason; canvas/style/geometry/PTY evidence remains open |
...
| Dungeon exploration/combat/loot | `dungeon_core_loop` | S,C,Y,G,T,P | `visual_transition_contract::dungeon_core_loop_matches_visual_contract` | Open | Open | Open | Open | Open | Open | Open | Green | D-01/D-02; GDD 3/8 | Fixed-dungeon movement/combat/extraction passed both C8 PTY profiles; complete automated visual evidence remains open |
