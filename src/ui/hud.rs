        ...
        .show(ctx, |ui| {
            ...
            ui.horizontal(|ui| {
                ...
                if let Some(progression) = progression {
                    ...
                    let defense_virtue_bonus = i32::from(progression.virtue_rank(VirtueId::Metis)) * 5;
                    let defense_rating = progression.proficiency_rating(ProficiencyId::QuietMovement);
